            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-success" id="exampleModalLabel">Dialog Hasil</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p class="text-success text-center ">Biaya yang diperlukan adalah</p>
...
$(document).ready(function(){
    ...
    $.ajax({
    type: "GET",
    url: '/index.php/api/ongkir?mode=Province',
    dataType: "json"
    }).done(function (data) {
        console.log(data)
    ...
    $('#provisi_origin').change(function(){
        ...
        $.get('/index.php/api/ongkir?mode=City&province='+province,function(data){
            //city origin
    ...
    $('#city').change(function(){
        ...
        $.get('/index.php/api/ongkir?mode=Postal&city='+city,function(data){
    ...
    $.get('/index.php/api/ongkir?mode=Province',function(data){
    ...
    $('#kurir').change(function(){
        ...
        $.get('/index.php/api/ongkir?mode=Cost&destination='+destination+'&origin='+origin+'&kurir='+kurir,function(data){
            var html = '';
