...
$(document).ready(function(){
    ...
    $('#provisi_origin').change(function(){
        ...
        $.get('/index.php/api/ongkir?mode=Province?mode=City&province='+province,function(data){
            //city origin
    ...
    $('#city').change(function(){
        ...
        $.get('/index.php/api/ongkir?mode=Province?mode=Postal&city='+city,function(data){
    ...
    $.get('/index.php/api/ongkir?mode=Province,?mode=Province',function(data){
    ...
    $('#kurir').change(function(){
        ...
        $.get('/index.php/api/ongkir?mode=Province?mode=Cost&destination='+destination+'&origin='+origin+'&kurir='+kurir,function(data){
            var html = '';
